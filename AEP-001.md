...
and Lockb0x escrow contracts on Base). The `stellar-x402` rail is normative
with open-source reference code but no hosted reference service. Rail
normativity is independent of any party operating infrastructure for it.
